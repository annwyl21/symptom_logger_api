...
if __name__ == '__main__':
	...
	test_data = [{"date":"2023-10-01","time":"20:49","pain_score":1,"description":"Slight discomfort in right hip"},
	...
	data = Summarize.organize_data(test_data)
	summary = Summarize.create_summary(test_data)
	# print(summary)